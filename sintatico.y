...
S 				: FUNCOES BLOCOGLOBAL BLOCOCONTEXTO {/*cout<<"Entro na main"<<endl;entryMain++;*/} TK_MAIN '(' ')' BLOCO 
				{
					cout << "/*Salve Kappa!*/\n" << "\n#include <iostream>\n#include<string.h>\n#include<stdio.h>\nusing std::string;\n\n" + $1.traducao + "\nint main(void)\n{\n" << 
					"//------------------ Escopo Variáveis ------------------\\\\ \n" << $1.traducao_dec << $2.traducao_dec << $8.traducao_dec << 
					"//------------------ Escopo Atribuições ------------------\\\\ \n" << $2.traducao << $8.traducao << "\treturn 0;\n}" << endl;
				}
				;
